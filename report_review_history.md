> **Superseded history.** This is the chronological log of all review rounds, kept for
> traceability (code docstrings cite its section names). Several numbers here are stale
> (e.g. m = 702, the 8.7% / 96.7% figures, the T3 p = 0.03 result, the 4-cluster label pilot).
> The current, authoritative account is `../report.md` and `../outputs/metrics.json`.
